...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#FFFDF9] text-gray-900 font-sans overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 w-full bg-[#FFFDF9]/90 backdrop-blur-md z-50 border-b border-gray-100">
        <div className="flex justify-between items-center py-4 px-6 md:px-10 max-w-7xl mx-auto">
          ...
          <div className="hidden md:flex space-x-8 text-sm font-semibold text-gray-600">
            ...
            <a href="#profil-bisnis" className="hover:text-[#F18B33] transition">Profil Bisnis</a>
          ...
          {/* Tombol Kanan */}
          <button className="bg-[#F18B33] hover:bg-[#d9792a] text-white px-6 py-2.5 rounded-full text-sm font-bold shadow-md transition">
            Daftar Mitra
          </button>
        </div>
      </nav>
      ...
      <section className="flex flex-col-reverse md:flex-row items-center justify-between max-w-7xl mx-auto px-6 md:px-10 pt-32 pb-12 md:pt-40 z-10">
        ...
        <div className="md:w-1/2 space-y-6 mt-12 md:mt-0 z-10">
          ...
          <p className="text-gray-600 text-lg max-w-lg leading-relaxed font-medium">
            Platform layanan harian terpercaya. <span className="text-[#8EAC79] font-bold">Butuh bantuan? Ayo suruh kami!</span> Temukan mitra terbaik untuk menyelesaikan pekerjaan Anda dengan cepat dan mudah.
          </p>
          
          <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-6 pt-4">
            <button className="bg-[#F18B33] hover:bg-[#d9792a] text-white px-8 py-3.5 rounded-full font-bold shadow-lg shadow-orange-200/50 transition w-full sm:w-auto">
              Daftar Mitra
            </button>
            <a 
              href="/ayoSuruh.apk" 
            ...
            >
              <span className="flex items-center justify-center w-10 h-10 rounded-full border-2 border-[#F18B33] text-[#F18B33] group-hover:bg-[#F18B33] group-hover:text-white transition">
                <svg xmlns="http://w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="18" height="18">
        ...
        <div className="bg-[#8EAC79]/10 rounded-3xl p-8 md:p-16 flex flex-col md:flex-row items-center gap-10">
          <div className="md:w-1/2 space-y-4">
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              ayoSuruh hadir sebagai solusi untuk mengatasi kerepotan aktivitas harian Anda. Kami menghubungkan Anda dengan mitra terpercaya yang siap membantu segala kebutuhan—mulai dari berbelanja, mengantar barang, hingga pekerjaan rumah tangga lainnya.
            </p>
          </div>
          <div className="md:w-1/2 grid grid-cols-2 gap-4">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 text-center">
              <h3 className="text-2xl font-black text-[#F18B33]">500+</h3>
              <p className="text-gray-500 font-medium">Mitra Aktif</p>
            </div>
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 text-center">
      ...
      <section id="visi-misi" className="max-w-7xl mx-auto px-6 md:px-10 mt-10 pt-20 scroll-mt-20">
        <div className="text-center mb-16 space-y-2">
          ...
          <p className="text-gray-500 max-w-xl mx-auto">Visi dan misi ayoSuruh untuk memberikan dampak positif bagi pengguna dan mitra.</p>
        </div>
          ...
          <div className="bg-white p-10 rounded-3xl shadow-lg shadow-gray-100/70 border border-gray-100 relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-4">
              ...
              <ul className="text-gray-700 leading-relaxed text-lg list-disc list-outside pl-5 space-y-3 font-medium">
                <li>Menyediakan layanan bantuan yang cepat, aman, dan andal untuk kebutuhan sehari-hari pengguna.</li>
                <li>Memberdayakan mitra lokal dengan memberikan akses ke peluang ekonomi yang adil dan fleksibel.</li>
                <li>Memanfaatkan teknologi inovatif untuk mempermudah hidup pengguna melalui solusi layanan yang cerdas.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-[#F18B33] p-8 rounded-3xl shadow-lg shadow-orange-200 flex flex-col justify-between">
            <div>
              ...
              <p className="text-orange-50 italic mb-6">"Nggak cuma pelanggannya yang diuntungin, saya sebagai mitra juga merasa sistem bagi hasilnya sangat fair. Maju terus ayoSuruh!"</p>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-[#F18B33] font-bold">D</div>
              <div>
                <h4 className="font-bold text-white">Dimas P.</h4>
      ...
      <footer className="bg-white border-t border-gray-100 pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-6 md:px-10 flex flex-col items-center">
          ...
          {/* Sosial Media (Icon SVG) */}
          <div className="flex space-x-8 mb-6">
            {/* Instagram Icon */}
            <a href="https://www.instagram.com/ayo.suruh?igsh=ejZpYWEzdG55MTh3" target="_blank" className="text-gray-400 hover:text-[#F18B33] transition-colors duration-300" aria-label="Instagram">
            ...
            {/* WhatsApp Icon */}
            <a href="#" target="_blank" className="text-gray-400 hover:text-[#8EAC79]  transition-colors duration-300" aria-label="WhatsApp">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {/* Email Icon */}
            <a href="#" target="_blank" className="text-gray-400 hover:text-[#F18B33] transition-colors duration-300" aria-label="Email">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {/* Nama Brand Tanpa Logo */}
          <div className="mb-10">
            <span className="font-black text-2xl text-gray-300 tracking-widest">
              AYO SURUH
            </span>
          </div>

          {/* Copyright Area */}
          <div className="w-full text-center border-t border-gray-100 pt-8 mt-2">
            <p className="text-gray-400 text-sm font-medium tracking-wide">
              Copyright &copy; 2026 by <span className="font-bold text-gray-500">Madousei Xalisphera</span>. anjay
            </p>
          </div>
