  ...
  return (
    <main className="min-h-screen bg-[#FFFDF9] text-gray-900 font-sans overflow-x-hidden scroll-smooth">
      ...
      <nav className="fixed top-0 left-0 w-full bg-[#FFFDF9]/90 backdrop-blur-md z-50 border-b border-gray-100">
        <div className="flex justify-between items-center py-4 px-4 md:px-10 max-w-7xl mx-auto gap-3">
          {/* Logo Section */}
          <div className="flex items-center gap-3 shrink-0">
            <Image 
              ...
              width={50} 
              height={50}
              className="mix-blend-multiply object-contain w-10 h-10 md:w-[50px] md:h-[50px]"
            />
          ...
          {/* Tombol Kanan (Diperbaiki untuk Mobile) */}
          <a href="https://wa.me/628895255693" target="_blank" className="bg-[#F18B33] hover:bg-[#d9792a] text-white px-5 py-2 md:px-8 md:py-3.5 rounded-full font-bold shadow-lg shadow-orange-200/50 transition text-sm md:text-base whitespace-nowrap shrink-0">
            Hubungi Kami
          </a>
        </div>
      </nav>
      ...
      {/* 2. HERO SECTION */}
      <section className="flex flex-col-reverse md:flex-row items-center justify-between max-w-7xl mx-auto px-6 md:px-10 pt-28 pb-12 md:pt-40 z-10">
        
        {/* Kiri: Copywriting (Dibuat rata tengah untuk mobile) */}
        <div className="md:w-1/2 space-y-6 mt-8 md:mt-0 z-10 flex flex-col items-center md:items-start text-center md:text-left">
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight">
            Selamat datang di website <br className="hidden md:block" />
            <span className="text-[#F18B33]"> ayoSuruh</span>
          </h1>
          
          <p className="text-gray-600 text-lg max-w-lg leading-relaxed font-medium">
            Platform aplikasi mobile yang mempertemukan mahasiswa yang membutuhkan bantuan dengan mitra yang ingin mendapatkan penghasilan tambahan secara cepat, aman, dan fleksibel. Serahkan kebutuhan harianmu pada kami agar tidak mengganggu jadwal kuliah. <span className="text-[#8EAC79] font-bold block mt-2">Butuh bantuan? Ayo suruh kami!</span> 
          </p>
          
          <div className="flex flex-col sm:flex-row items-center md:items-start justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4 pt-4 w-full">
      ...
      <section id="profil-bisnis" className="max-w-7xl mx-auto px-6 md:px-10 mt-20 pt-20 pb-10 scroll-mt-20">
        <div className="bg-[#8EAC79]/10 rounded-3xl p-8 md:p-16 flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="md:w-1/2 grid grid-cols-2 gap-4 w-full">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 text-center flex flex-col justify-center items-center h-full">
              <h3 className="text-2xl font-black text-[#F18B33]">100%</h3>
              <p className="text-gray-500 font-medium mt-1">Aman & Terpercaya</p>
            </div>
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 text-center flex flex-col justify-center items-center h-full">
              <h3 className="text-2xl font-black text-[#F18B33]">24/7</h3>
              <p className="text-gray-500 font-medium mt-1">Siap Bantu</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="visi-misi" className="max-w-7xl mx-auto px-6 md:px-10 mt-10 pt-20 scroll-mt-20">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-white p-10 rounded-3xl shadow-lg shadow-gray-100/70 border border-gray-100 relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-4 flex flex-col items-center text-center md:items-start md:text-left">
              <div className="w-14 h-14 bg-[#F18B33]/10 text-[#F18B33] rounded-2xl flex items-center justify-center mb-4 md:mb-6 border border-[#F18B33]/20">
          ...
          <div className="bg-white p-10 rounded-3xl shadow-lg shadow-gray-100/70 border border-gray-100 relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-4 flex flex-col items-center md:items-start text-center md:text-left">
               <div className="w-14 h-14 bg-[#8EAC79]/10 text-[#8EAC79] rounded-2xl flex items-center justify-center mb-4 md:mb-6 border border-[#8EAC79]/20">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8">
              ...
              <ul className="text-gray-700 leading-relaxed text-lg list-disc list-outside pl-5 space-y-3 font-medium text-left">
      ...
      <section id="layanan" className="max-w-7xl mx-auto px-6 md:px-10 mt-20 pt-20 scroll-mt-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Layanan 1 */}
          <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-xl transition-shadow duration-300 border border-gray-100 group flex flex-col items-center text-center md:items-start md:text-left">
      ...
      <section id="aplikasi" className="max-w-7xl mx-auto px-6 md:px-10 mt-24 pt-20 scroll-mt-20">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 relative">
          ...
          {/* Kolom Kiri: Teks & Tombol (Dibuat rata tengah untuk mobile) */}
          <div className="md:w-1/2 space-y-6 relative z-10 flex flex-col items-center md:items-start text-center md:text-left">
      ...
      <section id="testimoni" className="max-w-7xl mx-auto px-6 md:px-10 mt-20 pt-20 pb-32 scroll-mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-[#F18B33] p-8 rounded-3xl shadow-lg shadow-orange-200 flex flex-col justify-between">
            <div>
              <div className="flex text-white mb-4 justify-center md:justify-start">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                     <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clipRule="evenodd" />
                  </svg>
      ...
      {/* 8. FOOTER SECTION */}
      <footer className="bg-[#F8F6E9] pt-16 pb-8 border-t border-gray-200 mt-10 text-center md:text-left">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <ul className="space-y-4 text-gray-600 font-medium text-center md:text-left">
          ...
          {/* Copyright Area */}
          <div className="border-t border-[#7C9A6A]/20 pt-8 text-center">
